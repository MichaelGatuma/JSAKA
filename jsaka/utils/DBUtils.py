...
class dbConnection:
    def __init__(self):
        ...
        self.__cur.execute("create table IF NOT EXISTS  site_keyword(subscriber_id INTEGER, site_id INTEGER,keyword_id INTEGER)")
        self.__cur.execute("create table IF NOT EXISTS  subscriber(subscriber_id INTEGER PRIMARY KEY ASC,email TEXT(100) UNIQUE ,site_id INTEGER,keyword_id INTEGER)")
